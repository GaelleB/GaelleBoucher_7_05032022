<template>
    <div>
        ...
        <form>
                ...
                <button @click="ModifyPostView()" class="btnSave" aria-label="Modifier ce post"><i class="fas fa-edit"></i> Enregistrer</button>
            </section>
            <div>
            ...
            <div>
            <router-link to="/FilActuView" aria-label="Retour ver Le Flash Actu Groupomania"><i class="fas fa-home home"></i></router-link>
            </div>
        <Footer />
    </div>
</template>
